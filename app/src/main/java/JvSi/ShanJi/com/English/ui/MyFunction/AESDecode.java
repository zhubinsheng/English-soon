...
public class AESDecode {
    private static String ak_id = "LTAIUgqqcsXX4kaC";
    private static String ak_secret = "WZB53huLjmBkiSHDjQz4wnaq8zWccG";
    ...
    public static String HMACSha1(String data, String key) {
        ...
        try {
            ...
            result = (new Base64()).encode(rawHmac);
        } catch (Exception e) {
    ...
    public static String sendPost(String url, String body, String ak_id, String ak_secret) throws Exception {
        ...
        Log.d("timebbb10","333>>>>>>>>>>>>>>>      "+curClickTime3);
        ...
        Log.d("timebbb10","444>>>>>>>>>>>>>>>      "+curClickTime4);
        EventBus.getDefault().post(ClassifyMessageEvent.getInstance("imageInfo",result));
        return result;
    }
    /*
     * GET请求
    ...
    public static void main(String image_url) throws Exception {
        // 发送POST请求示例
        ...
        AESModel aesModel = new AESModel(0,image_url);
        Gson gson = new Gson();
        String requestBody = gson.toJson(aesModel);

        //String body = "{\n" + "\t\"type\": 0,\n" + "\t\"image_url\": \"http://px32gts87.bkt.clouddn.com/Flm4iAsbPi4hOsIeVjfF5J4Wa4JE\"\n" + "}";
        //System.out.println("response body:" + sendPost(url, requestBody, ak_id, ak_secret));
        new Thread(new Runnable(){
            @Override
            public void run() {
                try {
                    sendPost(url, requestBody, ak_id, ak_secret);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
