...
public class HeXinUtil {
    ...
    private static String CALENDARS_NAME = "JvSi.ShanJi.com.Englis";
    private static String CALENDARS_ACCOUNT_NAME = "JvSi.ShanJi.com.Englis";
    private static String CALENDARS_ACCOUNT_TYPE = "JvSi.ShanJi.com.Englis";
    private static String CALENDARS_DISPLAY_NAME = "JvSi.ShanJi.com.Englis";
    ...
    public static boolean insertCalendarEvent(Context context, String title, String description,
        ...
        try {
            ...
            eventValues.put(CalendarContract.Events.EVENT_LOCATION, "app");
