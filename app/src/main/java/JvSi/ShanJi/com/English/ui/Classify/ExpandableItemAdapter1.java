...
public class ExpandableItemAdapter1 extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
    private static final String TAG = ExpandableItemAdapter1.class.getSimpleName();
     ...
     */
    public ExpandableItemAdapter1(Context context, List<MultiItemEntity> data) {
        super(data);
    ...
    protected void convert(final BaseViewHolder holder, final MultiItemEntity item) {
        switch (holder.getItemViewType()) {
            case TYPE_LEVEL_0:
                ...
                final ClassifyLevel1Item lv0 = (ClassifyLevel1Item) item;
...
//                            }
            ...
            case TYPE_PERSON:
                final WordList library = (WordList) item;
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        int pos = holder.getAdapterPosition();
                        EventBus.getDefault().post(ClassifyMessageEvent.getInstance("classify1",library.getClassify()));
